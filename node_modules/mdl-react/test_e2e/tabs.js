module.exports = {
	...
	'Props Doc' : function(client) {
		...
		var PROPS = [
			'children', 'tabLabels', 'defaultIndex', 'isRipple', 'justify', 'style'
		];
	...
	'Tabs Test': function(client) {
		...
		client.click('[href="#mdl-tab-1-Starks-0"]');
		client.expect.element('#mdl-tab-1-Starks-0').visible;
		client.expect.element('#mdl-tab-1-Lannisters-1').not.visible;
		client.expect.element('#mdl-tab-1-Targaryens-2').not.visible;

		client.click('[href="#mdl-tab-1-Targaryens-2"]');
		client.expect.element('#mdl-tab-1-Targaryens-2').visible;
		client.expect.element('#mdl-tab-1-Lannisters-1').not.visible;
		client.expect.element('#mdl-tab-1-Starks-0').not.visible;

		client.click('.mdl-card > div + div > button:nth-child(1)');
		client.expect.element('#mdl-tab-1-Lannisters-1').visible;
