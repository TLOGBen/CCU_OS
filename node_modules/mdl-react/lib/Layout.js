...
module.exports = React.createClass({
	...
	_perf : function() {
		var time = Date.now() - this._startRender;
		time += 'ms';
		console.debug('Layout._perf ' + time);
	},
	...
	_generateLinks : function(items, className, activeIndex) {
		...
		return items.map(function(item, index) {
			...
			return React.cloneElement(item, {
				...
				onClick : function(e) {
					// console.debug('link.onClick', item.props);
					if(!item.props.disableAutoCloseDrawer) {
						self._closeDrawer();
					}
				...
				onTouchTap : function(e) {
					// console.debug('link.onTouchTap', item.props);
					if(!item.props.disableAutoCloseDrawer) {
						self._closeDrawer();
					}
		...
		return (
			React.createElement("header", {className: className, style: this.props.headerStyle}, 
				React.createElement("div", {className: "mdl-layout__header-row"}, 
					React.createElement(LayoutComponents._HeaderTitle, {
					...
					haderNav, 
					React.createElement(LayoutComponents._HeaderSearch, {
						enabled: this.props.showHeaderSearch, 
						submit: this.props.onSearchSubmit, 
						style: this.props.searchInputStyle
					})
				), 
				React.createElement(LayoutComponents._HeaderWaterfall, {
				...
				React.createElement(LayoutComponents._HeaderTabs, {
