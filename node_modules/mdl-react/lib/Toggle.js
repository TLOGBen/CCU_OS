	...
	render: function() {
		...
		return (
			React.createElement("label", {ref: "label", 
				...
				React.createElement(ToggleText, {
...
var ToggleText = React.createClass({
	...
	render: function() {
		if(this.props.type == 'icon-toggle') {
			return React.createElement("i", {className: "mdl-icon-toggle__label material-icons"}, 
				this.props.text
			);
		} else {
			return React.createElement("span", {className: 'mdl-' + this.props.type + '__label'}, 
				this.props.text
			)
		}
	},
