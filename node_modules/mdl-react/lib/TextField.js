...
module.exports = React.createClass({
	...
	render : function() {
		...
		return (
			React.createElement("div", {key: this.state.changeCounter, 
...
var TextFieldError = React.createClass({
	displayName : 'MDL:TextField:Error',
	render: function() {
		var style = {
			right : 0,
		};
		if(this.props.children) {
			return (
				React.createElement("span", {className: "mdl-textfield__error", style: style}, 
					this.props.children
				)
			);
		} else {
